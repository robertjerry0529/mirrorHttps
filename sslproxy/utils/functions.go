...
func getRequestTlsFreeCfg() (conf *tls.Config, err error) {

	var tlscfg tls.Config
	tlscfg.InsecureSkipVerify = true // {/* 不校验服务端证书，直接信任 */InsecureSkipVerify: true, CipherSuites: [7]uint16{0x1301, 0x1302, 0x1303, 0x0035, 0x002f, 0x009d, 0x009c}}
